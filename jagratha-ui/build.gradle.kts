...
sourceSets["main"].output.dir(mapOf("builtBy" to "precompileJte"), file("build/jte-classes"))
...
// Tailwind CSS task
tasks.register<PnpmTask>("tailwind") {
...
tasks.named<ProcessResources>("processResources") {
    dependsOn(tasks.named("tailwind"))
...
tasks.named<JacocoReport>("jacocoTestReport") {
    onlyIf { tasks.named<Test>("test").get().didWork || file("${layout.buildDirectory.get()}/jacoco/test.exec").exists() }
}
